...
if [[ $1 == "sitl" ]]
then
	cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DPLATFORM=Drone -DSLAMTYPE=ORB2 -DAUTOPILOT=NEW .. 
else
	cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DPLATFORM=Laptop -DSLAMTYPE=ORB3 .. 
fi
